...
| `always_fast` | bool | `false` | Start every session with fast mode for Anthropic Opus (API) or eligible Codex subscription models (ChatGPT OAuth; ignored otherwise) |
